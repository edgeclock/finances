...
| Cash on hand | PHP 3,303.50 | **NEC jar** - cash (post travel-expense correction) |
...
**Total assets:** PHP 54,202.72 (jars 53,670.31 + Tonik/Alkansya 532.41)
...
- Dashboard: new "6-jar summary" section shows per-jar balance vs target with OK/LOW/OVER status (tolerance 1.00 for split rounding). Jar balances: NEC 25,718.08 (LOW vs 28,152.08 - travel expense + spend), FFA 5,630.41 (OK), LTSS 5,630.42 (OK), EDU 5,630.42 (OK), PLAY 5,642.27 (OK), GIVE 5,418.71 (OVER - pre-funded, expected).
