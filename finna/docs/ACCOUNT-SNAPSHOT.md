...
**Latest update:** Sep 9 breakfast PHP 190 from GCash wallet. GCash balance PHP 1,702.91 to PHP 1,512.91.
...
|---|---:|---|
| GCash wallet | PHP 2,833.66 | **NEC jar** - spending |
...
| GoTyme nec vault | PHP 10,762.36 | **NEC jar** - GoTyme vault (housing/essentials) |
