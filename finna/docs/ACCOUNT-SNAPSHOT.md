...
**Latest update:** Sep 13 Give/org contribution PHP 1,000 paid from the GoTyme LTSS wallet. GoTyme Professional Development (LTSS) balance PHP 5,630.42 to PHP 4,630.42. The expense is recorded as Charity with a GIVE jar override; the source account remains LTSS. Reconciliation is flagged because no GIVE wallet movement was booked.
...
| Coins.ph PHP | PHP 4,418.71 | **GIVE jar** - charity/tithes |
