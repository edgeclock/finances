...
**Latest update:** Sep 13 Give/tithes/charity PHP 500 from Coins.ph, reducing Coins.ph PHP 3,418.71 to PHP 2,918.71. The Sep 13 Give/org contribution PHP 1,000 remains recorded with a GIVE jar override from the GoTyme LTSS wallet; its wallet-purpose reconciliation remains pending.
