...
**Latest update:** Sep 12 internal transfer PHP 500 from GoTyme NEC to GCash. GoTyme NEC balance PHP 1,671.59 to PHP 1,171.59; GCash balance PHP 1,397.91 to PHP 1,897.91. Transfer only, not an expense.
...
|---|---:|---|
| GCash wallet | PHP 1,897.91 | **NEC jar** - spending |
